...
+ Zhaorun Zhou, Jinshan Pan, Jinhui Tang: "*Wavelet-Based Adaptive Vision State Space Network for Image Harmonization.*" IJCV (2026) [[paper]](https://link.springer.com/article/10.1007/s11263-026-02981-2)
...
+ Zhongyun Hu, Ntumba Elie Nsampi, Xue Wang, Qing Wang: "*SIDNet: Learning Shading-Aware Illumination Descriptor for Image Harmonization.*" T-ETCI (2024) [[pdf]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10411924)
...
+ Zhongyun Hu, Jiahao Li, Xue Wang, Qing Wang: "*Spatially-Varying Illumination-Aware Indoor Harmonization.*" IJCV (2024) [[arXiv]](http://www.npu-cvpg.org/uploads/file/24_01_05_02_57_01_603.pdf) [[code]](https://github.com/waldenlakes/IndoorHarmony-Dataset)
